...
export const servers: Servers = [
 ...
 { name: '[US]CraftersLand | FTB Infinity Evolved', ip: 'inf.craftersland.net', type: 'ftbie', website: 'https://www.craftersland.net', discord: 'HurWCR33', lang: 'en' },
 { name: '[DE]CraftersLand | FTB Infinity Evolved', ip: 'mc.myftb.de', type: 'ftbie', website: 'https://www.craftersland.net', discord: 'HurWCR33', lang: 'en' },
 { name: 'StoneLegion | FTB Infinity Evolved', ip: 'mc.stonelegion.com', type: 'ftbie', website: 'https://stonelegion.com/', discord: 'kBTabCX', lang: 'en' },
 { name: 'CDU | Fantasy MC', ip: 'fmc.playcdu.co', type: 'fantasymc', website: 'https://craftdownunder.co/', discord: 'playcdu', lang: 'en' },
 { name: 'CDU | Enigmatica 9', ip: 'e9.playcdu.co', type: 'enigm9', website: 'https://craftdownunder.co/', discord: 'playcdu', lang: 'en' },
 { name: '[EU]CDU | ATM9', ip: 'atm9eu.playcdu.co', type: 'atm9', website: 'https://craftdownunder.co/', discord: 'playcdu', lang: 'en' },
 { name: '[US]CDU | ATM9', ip: 'atm9mc.playcdu.co', type: 'atm9', website: 'https://craftdownunder.co/', discord: 'playcdu', lang: 'en' },
 { name: '[US]CDU | BCG and the Holy Grail', ip: 'bcghg.playcdu.co', type: 'atm9', website: 'https://craftdownunder.co/', discord: 'bigchadguys', lang: 'en' },
 { name: '[US1]CDU | BCG and the Holy Grail +', ip: 'bcg.us.playcdu.co', type: 'bcg', website: 'https://craftdownunder.co/', discord: 'bigchadguys', lang: 'en' },
 { name: '[US2]CDU | BCG and the Holy Grail +', ip: 'bcg2.us.playcdu.co', type: 'bcg', website: 'https://craftdownunder.co/', discord: 'bigchadguys', lang: 'en' },
 { name: '[EU]CDU | BCG and the Holy Grail +', ip: 'bcg.eu.playcdu.co', type: 'bcg', website: 'https://craftdownunder.co/', discord: 'bigchadguys', lang: 'en' },
